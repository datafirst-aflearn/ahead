...
`school_id` and `student_id` are retained in string format. See [Demographics and pupil context — Important considerations](05-context-demographics-survey-study-design.html) for identifier scope and linkage limitations.
